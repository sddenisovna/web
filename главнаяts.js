/* главная/главнаяts.ts */
console.log("✅ главнаяts.ts загружен");
var popularTrainings = [
  ...
  { id: 3, title: "барре", trainer: "Маргарита Робби", district: "Самарский район", rating: 5, reviews: 156, image: "https://hollywoodlife.com/wp-content/uploads/2022/04/barre-and-pilates-ball-hl.jpg?fit=1000%2C990" },
  ...
  { id: 5, title: "горячая йога", trainer: "Анжелика Джоли", district: "Железнодорожный район", rating: 5, reviews: 67, image: "https://i.pinimg.com/736x/cd/f1/fb/cdf1fb5f3aa7b4854a1292f3be960720.jpg" },
  { id: 6, title: "горячий пилатес", trainer: "Карина Кардашьян", district: "Самарский район", rating: 5, reviews: 169, image: "https://avatars.mds.yandex.net/i?id=0a6b51814635907a4d7d0296cbfc81d5_l-5575009-images-thumbs&n=13" }
];
...
function bookTraining(training) {
  ...
  bookBtns.forEach((btn, index) => {
    ...
    newBtn.addEventListener("click", (e) => {
      ...
      if (training) {
        ...
        const card = newBtn.closest(".popular-card");
