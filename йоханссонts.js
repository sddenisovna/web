/* йоханссон/йоханссонts.ts */
console.log("✅ йоханссонts.ts загружен");
var trainerData = {
  id: 2,
  ...
  experience: 6,
  clubs: ["Ленинский"],
  specializations: ["пилатес", "растяжка", "бой с тенью"],
  phone: "+7 (800) 555-35-35",
  email: "a.jahansson@tochkaofbalance.ru",
  schedule: {
    monday: "10:00-19:00",
    tuesday: "10:00-19:00",
...
function init() {
  console.log("\uD83D\uDE80 Страница тренера Александра Йоханссон загружена");
  renderTrainerData();
  initScheduleButton();
  initBookButton();
  initBackButton();
